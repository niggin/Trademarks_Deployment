...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserReaction.user_word'
        db.add_column(u'trademarks_userreaction', 'user_word',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trademarks.History'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserReaction.user_word'
        db.delete_column(u'trademarks_userreaction', 'user_word_id')
